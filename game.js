...
function reveal(p){
  ...
  document.getElementById("continue").onclick=()=>{
    ...
    updateProgress();
    if(current.id===target.id){if(completed.size===activeTasks.length)finish();else{statusEl.textContent="META osiągnięta, ale najpierw zalicz wszystkie misje ("+completed.size+"/"+activeTasks.length+").";}}
  };
