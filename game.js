...
function taskForGame(){
  ...
  if(settings.architects){
    ...
    architectNames.forEach(name=>pool.push({type:"arch:"+name,category:"architects",text:"Odwiedź obiekt z architektem: "+name,test:p=>String(p.architect||"").includes(name)}));
  }
